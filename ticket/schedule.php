...
<html lang="ko">
    ...
    <body>
        ...
        <div id="subBox">
            ...
            <nav id="subMenu">
                <ul>
                    <li class="first out"><a href="ticketing.php">예매하기</a></li>
                    <li class="last active"><a href="schedule.php">상영시간표</a></li>
                </ul>
            </nav>
            <div id="scheduleBox">
                <h3>상영관별 영화 시간표</h3>
