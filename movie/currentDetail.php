...
<html lang="ko">
    <head>
        ...
        <script src="../js/currentDetail.js"></script>
    </head>
    <body>
        <header>
            <div class="hTop">
            ...
            <div class="hBottom">
                <nav class="gnb">
                    <ul>
                        <li>
                            <a href="current.php" class="mainNav">영화</a>
                            <ul class="subNav">
                                <li><a href="current.php">현재상영작</a></li>
                                <li><a href="future.php">상영예정작</a></li>
        ...
        <div id="titleBox">
            <div class="titleWrap">
                <div class="title">
                    <h2 class="name"></h2>
                    <ul class="middle">
                        <li class="like first"><a href="#"></a></li>
                        <li class="share"><a href="#">공유하기</a></li>
                    </ul>
                    <ul class="bottom">
                        <li class="rate">
                            <h4>예매율</h4>
        ...
        <div id="descriptBox">
            ...
            <div class="imgBox">
                <h3>스틸컷</h3>
                <ul>
                    <li class="stillCut stillcut01">
                        <img alt="스틸컷 이미지01">
                    </li>
                    <li class="stillCut stillcut02">
                        <img alt="스틸컷 이미지02">
                    </li>
                    <li class="stillCut stillcut03">
                        <img alt="스틸컷 이미지03">
                    </li>
                </ul>
            </div>
