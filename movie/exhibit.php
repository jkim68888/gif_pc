...
<html lang="ko">
    ...
    <body>
        ...
        <div id="subBox">
            ...
            <nav id="subMenu">
                <ul>
                    <li class="first out"><a href="current.php">현재상영작</a></li>
                    <li class="middle out"><a href="future.php">상영예정작</a></li>
                    <li class="last active"><a href="exhibit.php">기획전</a></li>
                </ul>
            </nav>
            <div id="exhibitMovie"></div>
        </div>
        <footer>
            <div class="wrap">
                <h1>
