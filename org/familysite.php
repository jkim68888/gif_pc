...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="../css/familysite.css">
    ...
    <body>
        ...
        <div id="subBox">
            ...
            <nav id="subMenu">
                <ul>
					<li class="first out"><a href="introduce.php">단체소개</a></li>
					<li class="middle active"><a href="familysite.php">유관단체</a></li>
					<li class="last out"><a href="identity.php">CI</a></li>
				</ul>
            </nav>
            <div id="siteWrap">
                <div class="site odd">
                    ...
                    <div class="right">
                        <h3>광주독립영화협회</h3>
                        <p>
                            광주독립영화협회는 2009년에 출범했다.<br>
                            영화가 계속해서 만들어지는 토대를 구축하겠다는 취지였다.<br>
                            광주독립영화협회는 2012년 “살아있다”라는 슬로건을 내걸고 광주독립영화제를 1회 개최했던 것을 시작으로 8회 영화제를 치렀다.
                        </p>
                        <a href="https://www.facebook.com/gwangju.indif" target="_blank">홈페이지 바로가기</a>
                    </div>
                </div>
                <div class="site even">
                    <div class="left">
                        <h3>광주여성영화제</h3>
                        <p>
                            광주여성영화제는 2010년 1회를 시작으로 매년 11월,<br> 
                            ‘여성의 눈으로 보는 세상, 모두를 위한 축제’ 라는 슬로건으로 6일간 여성영화제를 개최하고 있다.<br>
                            영화제 기간 외에도 찾아가는 여성영화 상영회, 영화를 통한 성평등 교육, 여성영화인 제작 지원사업 등을 진행하고 있다.
                        </p>
                        <a href="http://www.wffig.com/" target="_blank">홈페이지 바로가기</a>
                    </div>
                ...
                <div class="site odd">
                    ...
                    <div class="right">
                        <h3>광주극장</h3>
                        <p>
                            1933년 개관한 광주극장은 국내에서 가장 오래된 단관극장 중 하나로 유서 깊은 근대역사유산이자<br> 
                            현재는 호남 유일의 예술영화전용관으로서 지역영화문화의 구심점 역할을 하고있다.<br>
                            부속 건물인 ‘영화의 집’에서는 매주 지역 영화인들과 영화애호가들이 참여하는 다양한 테마의 영화 소모임이 운영되고 있다.
                        </p>
                        <a href="https://cafe.naver.com/cinemagwangju" target="_blank">홈페이지 바로가기</a>
                    </div>
                </div>
                <div class="site even">
                    <div class="left">
                        <h3>필름에이지</h3>
                        <p>
                            광주의 대표적인 영화제작사로 극영화, 뮤직비디오, 광고, 홍보영상 등을 제작한다.<br>
                            지역주민들을 대상으로 정기적인 영화상영회를 통해 지역민들의 문화향유 확대에 기여하고 있으며 지역의 열악한 제작기반을 타개하기 위해 다양한 영화교육프로그램을 운영하고 있다.
                        </p>
                        <a href="http://www.filmage.kr/mobile/" target="_blank">홈페이지 바로가기</a>
                    </div>
                ...
                <div class="site odd">
                    ...
                    <div class="right">
                        <h3>문화콘텐츠그룹 잇다</h3>
                        <p>
                            잇다와 함께하는 일상이득 라이프! 가치, 사람, 공간, 문화, 참여, 기록과 기억을 ‘잇다’.<br>
                            영상콘텐츠, 교육콘텐츠, 문화콘텐츠의 ‘기획 ▶ 제작 ▶ 운영 ▶ 기록 ▶ 홍보 ▶ 기억’을 위한 크리에이터 그룹 잇다는 아트디렉터,<br> 
                            스토리텔러와 프로듀서, 촬영감독, 연출가 등이 동고동락하고 있는 문화콘텐츠그룹입니다.<br>
                        </p>
                        <a href="http://www.it-da.net/" target="_blank">홈페이지 바로가기</a>
                    </div>
                </div>
                <div class="site even">
                    <div class="left">
                        <h3>시네마라운지Mm</h3>
                        <p>
                            1930년대에 건축된 조선미곡창고를 개보수해 탄생한 전남 유일의 독립예술영화관 ‘시네마라운지Mm’은<br> 
                            목포에서 접하기 힘들었던 독립, 예술영화를 상영하며<br>
                            영화모임, 영화제작캠프, 국도1호선독립영화제 등 다양한 영상문화활동을 만들어가고 있다.
                        </p>
                        <a href="https://cinemaloungemm.modoo.at/" target="_blank">홈페이지 바로가기</a>
                    </div>
